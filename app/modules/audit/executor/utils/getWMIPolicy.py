...
def get_wmi_policy_actual_value(win_client: Client, audit: Audit) -> str:
    try:
...
def compare_wmi_policy(audit: Audit, stdout: str):
    # reg check
    ...
    expected_value = str(value_data_values[0]).lower()
